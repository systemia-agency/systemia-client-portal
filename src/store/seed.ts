...
export function seedData(): void {
  ...
  const mdaMakeCharges = (prefix: string, metaAds: number, googleAds: number, preparateur: number, saas: number) => [
    ...
    { id: `${prefix}-5`, label: 'Meta Ads', amount: metaAds, category: 'variable' as const, dependsOn: 'fixe' as const },
    { id: `${prefix}-5b`, label: 'Google Ads', amount: googleAds, category: 'variable' as const, dependsOn: 'fixe' as const },

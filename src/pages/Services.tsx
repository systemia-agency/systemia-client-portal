...
import { activeServices, optimizations } from '@/data/mock'
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Vos services actifs et les optimisations disponibles.
        </p>
      </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg bg-gradient-to-br from-blue-50 to-violet-50">
                      <Icon className="h-6 w-6 text-[var(--sys-violet)]" />
                    </div>
